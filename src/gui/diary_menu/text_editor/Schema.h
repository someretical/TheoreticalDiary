...
#include "gui/diary_menu/text_editor/markdownhighlighter.h"
...
public:
    ...
    QVariant getSchemaValue(
        const QString &key, const QVariant &defaultValue = QVariant(), QString schemaKey = QString()) const;
