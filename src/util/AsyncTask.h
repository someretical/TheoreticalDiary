...
#ifndef THEORETICAL_DIARY_ASYNCTASK_H
#define THEORETICAL_DIARY_ASYNCTASK_H
...
auto waitForFuture(QFuture<typename std::result_of<FunctionObject()>::type> future) ->
 ...
 */
template <typename FunctionObject>
auto runAndWaitForFuture(FunctionObject task) -> typename std::result_of<FunctionObject()>::type
{
...
#endif // THEORETICAL_DIARY_ASYNCTASK_H
